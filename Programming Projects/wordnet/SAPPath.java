public class SAPPath {
     ...
     */
    public SAPPath(Digraph G, int s) {
     ...
     */
    public SAPPath(Digraph G, Iterable<Integer> sources) {
        marked = new boolean[G.V()];
        distTo = new int[G.V()];
        edgeTo = new int[G.V()];
        for (int v = 0; v < G.V(); v++) distTo[v] = INFINITY;
